...
public class Pessoa {
    ...
    public String toString() {
        return "Pessoa{" + "nome=" + nome + ", ultimoNome=" + ultimoNome + ", nomeDoMeio=" + nomeDoMeio + ", apelido=" + apelido + ", nomeDoPai=" + nomeDoPai + '}';
    }
    ...
    public String getUltimoNBome() {
        return ultimoNome;
    }

    public void setUltimoNBome(String ultimoNBome) {
        this.ultimoNome = ultimoNBome;
    }
